...
#'
#' @importFrom \code{dplyr} for \code{tbl_df}, although use of \code{tidyverse} (which includes
#' \code{dplyr}) is recommended.
#'
#' @examples
#' fars_read(inputfile)
...
#' Uses \link{dplyr::mutate} and \link{dplyr::select}.  A list with the same number of elements as \code{years}
...
#'
#' @importFrom \code{dplyr}, although use of \code{tidyverse} (which includes \code{dplyr})
#' is recommended.
#'
...
#'@param years An list of interger values (or values that will cast to integer) repersenting years.
#'
#' @importFrom \code{dplyr} and \code{tidyr}, although use of \code{tidyverse} is recommended.
#'
...
#'
#' @importFrom \code{dplyr, maps} and \code{graphics}.  Use of \code{tidyverse} is recommended.
#'
